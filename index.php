  ...
  <header>
    <nav id="nav" class="nav1">
        <div class="container-nav">
            <div class="logo">
              <img src="image/randfood.png" alt="randfood">
            </div>
            ...
            <div class="nav-links-btn">
                ...
                <a href="#" id="link-cart" class="btn-header"><i class="fas fa-shopping-basket"></i> Carrito</a>
            </div>
...
<footer>
    ...
    <div class="legal-info">
            ...
            <p>Copyright © 2019 Randfood. All rights reserved.</p>
            </div>
